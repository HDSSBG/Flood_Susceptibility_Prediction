...
def netdischarge(basin_name):
    ...
    read_var = read_data.variables['discharge'][start_idx:end_idx,:,:]
    ...
    ds=Dataset('Streamflow.nc', mode="w", format='NETCDF4')
